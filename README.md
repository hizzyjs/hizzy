...
Check the [Language Support Example on GitHub](https://github.com/hizzyjs/hizzy/tree/main/examples/language)

## @hizzyjs/authentication

### Local authentication

Check the [Local Authentication Example on GitHub](https://github.com/hizzyjs/hizzy/tree/main/examples/local-auth)

### Discord authentication

Check
the [Discord Authentication Example on GitHub](https://github.com/hizzyjs/hizzy/tree/main/examples/discord-auth)
...
Check the [Helmet Example on GitHub](https://github.com/hizzyjs/hizzy/tree/main/examples/helmet)
...
Check the [Images Example on GitHub](https://github.com/hizzyjs/hizzy/tree/main/examples/images)
